...
cfg_rt! {
    ...
    /// Read-only allocation requests for the exact WP3 SQLx maintenance task.
    ///
    /// This is a representation query only. It grants no allocation allowance,
    /// owner identity, lifetime policy, or scheduler policy.
    #[cfg(feature = "rt-multi-thread")]
    #[doc(hidden)]
    #[derive(Debug, Copy, Clone, Eq, PartialEq)]
    pub struct OterynWp3TaskAllocationProfile {
        pub future_box_request: usize,
        pub task_cell_request: usize,
    }

    #[cfg(feature = "rt-multi-thread")]
    #[doc(hidden)]
    pub fn oteryn_wp3_multithread_task_allocation_profile<F>(
        future: &F,
