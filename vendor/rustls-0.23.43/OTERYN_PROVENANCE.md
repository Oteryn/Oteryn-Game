...
The complete published package is copied at this directory. The 116 package files outside the three authorized source files and this provenance file are byte-identical to the archive. The canonical sorted `SHA256  path\n` manifest for those untouched files has SHA-256 `4636769c464bc5e875ece3e5aa49499826534593b8e6fb30062664d25ad2c747`.
