...
class FakeAppearance:
    ...
    def resolve_outfit_presentation(product, **values):
        ...
        return {'outfit_presentation_id':'outfit-presentation:fixture','groups':[{'phase_count':2,'animation':{'loop_type':'infinite'}}]}

STATIC={
    'contract_id':'oteryn-game-atlas-export-v1','capability':'static-creatures-v1','semantic_digest':'sha256:old',
    'statistics':{'npcs':3,'monster_spawns':1,'unresolved':1,'ambiguous':1},
    'npcs':[
...
def main():
    with tempfile.TemporaryDirectory() as tmp:
        ...
        assert first['npcs'][1]['presentation_resolution_state']=='UNRESOLVED_APPEARANCE'
        assert first['npcs'][1]['presentation_reason']=='UNKNOWN_LOOK_TYPE'
        assert first['npcs'][1]['presentation_fallback']=='factual-marker'
        assert first['npcs'][2]['presentation_resolution_state']=='FALLBACK_MARKER'
