...
EXPECTED_MERGE_GATE_VALIDATE_JOB_SHA256 = (
    "3eb5d6162d3afade519cb2172388c9125b845fbc548220be3e67200b82eae409"
)
EXPECTED_MERGE_GATE_LANES_JOB_SHA256 = "21a545d6803975a49034e9556064fd9833df76df3c54f5786fec73c9950ad367"
EXPECTED_MERGE_GATE_ATLAS_FULLWORLD_JOB_SHA256 = (
    "a302c8f4e6385930594fa7327759af47ec1191b9934ce17e7a90f24ccae395af"
)
...
def main() -> int:
    ...
    if merge_gate.is_file():
        ...
        atlas_fullworld_digest = (
            ...
            if atlas_fullworld_block
            else None
        )
        if atlas_fullworld_digest != EXPECTED_MERGE_GATE_ATLAS_FULLWORLD_JOB_SHA256:
            errors.append(
                "merge gate Atlas fullworld job must exactly match the canonical exact-head lightweight regression contract"
            )
