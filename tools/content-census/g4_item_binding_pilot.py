...
def verify_stable_current_digest(observed: str, manifest: dict[str, Any], protected: dict[str, Any]) -> None:
    ...
    if manifest_digest != expected or observed != expected:
        raise PilotError("CURRENT_SOURCE_STABLE_OUTPUT_DRIFT")
        ...
        "typed_binding_candidates": [
            {
                ...
                "source": {"key": PROJECT_SOURCE_KEY, "revision": source_batch},
                "identity_namespace": IDENTITY_NAMESPACE,
                "external_id": row["external_id"],
                "source_capture_batch_digest": source_batch_digest,
                "source_revision_id": row["revision_id"],
                "source_revision_timestamp": row["revision_timestamp"],
