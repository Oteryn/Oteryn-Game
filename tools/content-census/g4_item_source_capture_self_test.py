...
def fixture():
    ...
    source_manifest = {
        ...
        "invariants": {"wiki_first_discovery": True, "starts_from_crystal_38157": False,
                       "source_shape_partition_complete": True,
...
def run():
    ...
    bad = copy.deepcopy(census)
    bad["pages"][0]["source_shape"] = "INFOBOX_ITEM"
    rejects(lambda: capture.transform(bad, refresh_manifest(bad)), "CENSUS_SOURCE_SHAPE_PARTITION_MISMATCH")
