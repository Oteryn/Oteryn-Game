...
After published-head local/hosted qualification, return the exact head, PR, two-path diff, check results and this review packet to the #162 control plane. Do not trigger independent review, merge, auto-merge or Merge Queue from this worker.
