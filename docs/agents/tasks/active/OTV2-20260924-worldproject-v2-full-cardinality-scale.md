...
Allocation: R2, Issue #162 comment 5821876689. Branch: `agent/otv2-worldproject-v2-full-cardinality-scale-r2`.

Implementation base: `6185045c20631b8614b1d4ad1dacc5d918f73b0a`. This successor supersedes the pre-PR R1 head `a510e6ab68a7b1d003b3f642350df3b653a82ebc` and corrects its workflow failure classification and evidence/task filenames. Status: implementation and repeatable measurement harness. Measurement results are emitted by the workflow artifact; this task does not decide a production limit or storage format.
