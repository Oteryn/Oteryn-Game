...
base_branch: main
branch: agent/otv2-g4-source-identity-binding-v2-r2
pr: null
...
- PROVEN: PR #846 is superseded by this exclusive successor allocation. Its successful run `36017466314` at predecessor head `c439aaf01328d88255a8339c57acb48595acfcd7` is historical-only validation and does not qualify this successor candidate.
...
- related/superseded PRs: #839 #840; predecessor #846 is superseded draft
...
```yaml
last_progress: exclusive r2 successor allocated after PR #846 was superseded; protected base includes #841
status: implementing
branch: agent/otv2-g4-source-identity-binding-v2-r2
head_sha: null
pr: null
