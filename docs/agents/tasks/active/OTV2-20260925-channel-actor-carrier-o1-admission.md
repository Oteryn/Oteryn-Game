...
- **Validation:** behavioral RED/GREEN, multi-capacity M/M+1, exhaustion, rollback and multi-hole reuse; structural no-scan proof; release-mode M=4,096 and M=131,072 measurement with named profile; Slot size before/after; strict fmt/Clippy; affected regression; governance and full game-gate.
