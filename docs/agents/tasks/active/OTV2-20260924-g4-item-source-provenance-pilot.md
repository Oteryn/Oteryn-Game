...
base: main
base_branch: main
branch: agent/otv2-g4-item-source-provenance-pilot-r2
issue: 162
pr: null
base_sha: 1c3cd863436d72ac826cc46fb2b3650b2cc675c7
head_sha: null
final_head_sha: null
...
This task creates a deterministic, source-only provenance capture for the direct namespace-0 TibiaWiki `Categoria:Itens` census already established by protected PR #803. It has a fresh repair allocation in #162 comment `5820876804` on branch `agent/otv2-g4-item-source-provenance-pilot-r2`, from protected base `main@1c3cd863436d72ac826cc46fb2b3650b2cc675c7`, with exact custody of the five paths listed below.

The first candidate PR #854 at `20f465f5b9b44035e7c7dfeb345a273de9d0b9c2` is superseded after Agent Governance run `36048919542` required standard task YAML metadata with positive issue/mode/status fields. This r2 successor has a fresh #162 allocation in comment `5820876804`; #854 validation is not reused.
