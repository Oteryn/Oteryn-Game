...
- canonical delivery PR #741 merged to protected `main` as `8ad99922d7140016df2de38bc3b6ae3a8d4edc1e`;
- remaining stale ownership/lifecycle closeout is superseded by Issue #745 and task `OTV2-20260922-control-plane-simplification-745`;
- no #740 writer custody remains after this archive movement.
