...
base: main
base_branch: main
branch: agent/otv2-g4-item-source-provenance-archive-r2
issue: 162
pr: 856
...
This task created a deterministic, source-only provenance capture for the direct namespace-0 TibiaWiki `Categoria:Itens` census already established by protected PR #803. It has a fresh lifecycle repair allocation in #162 comment `5820965458` on branch `agent/otv2-g4-item-source-provenance-pilot-r3`, from protected base `main@42a9a440d17293aa7746c3581596fab1a588f77f`, with exact custody of the five paths listed below.
...
This packet was archived under the lifecycle-only allocation in #162 comment `5821484529` on `agent/otv2-g4-item-source-provenance-archive-r2`, from protected `main@4c7e1c8402c721f58c108e4b6912a80aef7458ea`. That allocation authorizes only this archive move and its evidence JSON update; it grants no implementation, PR, or integration authority.
