...
Finding-family completion: verified constructor-valid extra pending/domain members and stale next-command cursor. RED ignored pending_extra; GREEN independently binds both extra-member flags and enumerates Older/Newer cursor operators. These are bounded FND02 coverage additions, not production changes. Final independent whole-diff review and exact-head CI evidence remain external.
