...
Work only under an exact coordinator allocation for Issue #93. Read live `main`, root/nearest governance, `RESOURCE_LIMITS_REGISTRY.json`, accepted GAME-ABILITY-01, GAME-INTERACTION-01, GAME-AI-01, VSL-MOVE-01 and the current next-wave master plan.
