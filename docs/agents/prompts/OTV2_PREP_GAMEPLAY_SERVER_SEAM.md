...
Work only under an exact coordinator allocation for Issue #96. Read live `main`, root/nearest governance, merged Foundation framing/codec/runtime/admission/reconnect implementation, FND-02/FND-03/FND-04, NET-TRANSPORT-01, QA-E2E, current `apps/game-server`, current registries and the current next-wave master plan.
