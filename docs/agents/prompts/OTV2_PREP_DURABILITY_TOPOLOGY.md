...
Work only under an exact coordinator allocation for Issue #94. Read live `main`, root/nearest governance, ADR-0004, DUR-01/02/03, FND-03/FND-04, GAME-CHAR, GAME-ITEM, ANL-01, current workspace/Cargo topology and the next-wave master plan plus hardening amendment.
