...
if __name__=='__main__':
    ...
    for name,schema_name in [('monster-target-template.proposal.json','monster.schema.json'),('monster-dependencies-template.proposal.json','monster-dependencies.schema.json')]:
