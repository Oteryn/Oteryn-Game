...
| ID Last Year z zachowanym odczytem/oceną | 1012 |
| ID Last Year bez zachowanej analizy | 2049 |
| Wszystkie zachowane rekordy, także spoza spisu | 1104 |
| Strony spisu, dla których każde ID ma zachowany odczyt/ocenę | 33 |
| Nowsze posty z identyfikatorami/datami/hashami | 1078 |
...
[Indeks źródeł](./source-index.json) i [kolejka pozostałych ID](./last-year-progress.json) pozwalają wznowić odczyt bez powtarzania już zachowanych OP. [Ocena jakości](./year-quality-index.json) obejmuje 468 nowszych rekordów; 119 wyłączono z recurrence problemów. Wyłączenie nie oznacza spamu: propozycje bez opisanego problemu nadal pozostają kandydatami.
