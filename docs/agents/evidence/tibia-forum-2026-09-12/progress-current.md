...
| ID Last Year z zachowanym odczytem/oceną | 796 |
| ID Last Year bez zachowanej analizy | 2265 |
| Wszystkie zachowane rekordy, także spoza spisu | 888 |
| Strony spisu, dla których każde ID ma zachowany odczyt/ocenę | 26 |
| Nowsze posty z identyfikatorami/datami/hashami | 589 |
...
[Indeks źródeł](./source-index.json) i [kolejka pozostałych ID](./last-year-progress.json) pozwalają wznowić odczyt bez powtarzania już zachowanych OP. [Ocena jakości](./year-quality-index.json) obejmuje 252 nowszych rekordów; 70 wyłączono z recurrence problemów. Wyłączenie nie oznacza spamu: propozycje bez opisanego problemu nadal pozostają kandydatami.
