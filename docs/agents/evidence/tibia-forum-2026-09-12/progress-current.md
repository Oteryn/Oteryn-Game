...
| ID Last Year z zachowanym odczytem/oceną | 1156 |
| ID Last Year bez zachowanej analizy | 1905 |
| Wszystkie zachowane rekordy, także spoza spisu | 1248 |
| Strony spisu, dla których każde ID ma zachowany odczyt/ocenę | 38 |
| Nowsze posty z identyfikatorami/datami/hashami | 1348 |
...
[Indeks źródeł](./source-index.json) i [kolejka pozostałych ID](./last-year-progress.json) pozwalają wznowić odczyt bez powtarzania już zachowanych OP. [Ocena jakości](./year-quality-index.json) obejmuje 612 nowszych rekordów; 140 wyłączono z recurrence problemów. Wyłączenie nie oznacza spamu: propozycje bez opisanego problemu nadal pozostają kandydatami.
