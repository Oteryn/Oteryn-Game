...
Recommended maximum active set:
...
## 6. Wave 2 — infrastructure-sensitive investigation
...
## 9. Existing implementation workers remain separate
...
## 11. Recommended concurrency

Normal operator target:
...
## 12. Recommended model/effort rationale
...
## 13. Completion of investigation programme
