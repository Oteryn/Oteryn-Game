...
For the exact Durability launch/resume sequence, packet schema, stale-head handling and selective analyst rerun rules, use `docs/agents/programs/OTERYN_DURABILITY_MULTIAGENT_LAUNCH_RUNBOOK.md`.
